...
$limit = 10;
$row = ($page - 1) * $limit;
$sql = "SELECT `AMPDB_No_`, `Gene Names`, `Organism`, `Protein names`, `Length`, `peptide activity`, `target organism` FROM `master2` WHERE (`activity` LIKE '%$term%') $selDs $filterQuery $sortFilter LIMIT $row,$limit";
