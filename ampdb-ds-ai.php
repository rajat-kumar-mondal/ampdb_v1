...
<head>
    ...
    <title>AMPDB Data Stat by Aliphatic Index</title>
...
<body>
    ...
    <div class="container mt-3">
        <div class="row" style="padding-left: 0rem;">
            <div class="col-sm text-start" style="font-weight: 400; font-size:xx-large">
                AMPDB Statistics: AMPDB Data Distribution by Aliphatic Index
            </div>
        </div>
    </div>
    <div class="container mt-2">
        <div class="row p-2 border border-2">
            ...
            <div style="margin-top: 0.3%; font-size: small;">
                <b style="font-weight: 500;">Note: </b><i>The initial scale is set to 40 of Y axis. Because the difference between lowest number of records and highest
                    ...
                    <table class="table border border-2 table-striped table-hover">
                        <thead class="bg-dark text-white">
                            <tr>
                                ...
                                <th style="font-weight: 500;">Range of Aliphatic Index</th>
    ...
    <script>
        ...
        function rescaleYAxis() {
            var newMax = Math.floor(Math.random() * 25000) + 1000;
            myChart.options.scales.y.max = newMax;
            myChart.update();
        }

        function rescaleXAxis() {
            var newMax = Math.floor(Math.random() * 25);
        ...
        myChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['0-10', '11-20', '21-30', '31-40', '41-50', '51-60', '61-70', '71-80', '81-90', '91-100', '101-110', '111-120', '121-130', '131-140', '141-150', '151-160', '161-170', '171-180', '181-190', '191-200', '201-210', '211-220', '221-230', '231-240', '241-250'],
                datasets: [{
                    label: '# of Record(s)',
                    data: [19, 45, 101, 221, 714, 3049, 8610, 19946, 21140, 11159, 4302, 967, 443, 176, 98, 69, 51, 35, 32, 4, 18, 7, 4, 7, 2],
