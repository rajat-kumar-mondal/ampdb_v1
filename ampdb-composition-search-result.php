...
<head>
    ...
    <title>AMPDB Peptide Composition Search Result</title>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-lg-19 bg-light rounded my-2 py-2">
                <h4 class="text-center text-success" style="font-size: 500; margin-top: 2%;"> AMPDB Peptide Composition Search Result
                </h4>
                <?php
                error_reporting(0);
                ?>
                <div style="margin-left:5%; margin-right:5%;"><b style="font-weight: 500;">Search Protein Composition: </b><?php if (strlen($_GET['term']) == 0) {
                                                                                                                                echo ", ";
                                                                                                                            } else {
                                                                                                                                echo str_replace("modifiedAA", "Modified_AA_Count", str_replace("acidicAACount", "Acidic_AA_Count", str_replace("basicAACount", "Basic_AA_Count", str_replace("phiAA", "Hydrophilic_AA_Count", str_replace("phoAA", "Hydrophobic_AA_Count",  str_replace(" undefined", "", str_replace("`", "", $_GET['term']) . ', '))))));
    ...
    <script>
        ...
        $.ajax({
            url: "compo-all-ids-browse-all-data.php",
            type: "POST",
            data: {
                term: term,
                ds: ds,
        ...
        $.ajax({
            url: "compo-count-browse-all-data.php",
            type: "POST",
            data: {
                term: term1,
                ds: ds1,
        ...
        $.ajax({
            url: "compo-option-browse-all-data.php",
            type: "POST",
            data: {
                term: term2,
                ds: ds2,
        ...
        function showdata() {
            isrunning = true;
            $("#loading").show();
            $.post("compo-data-browse-all-data.php", {
                term: term3,
                ds: ds3,
                page: page_no,
                activity: activity3,
        ...
        function submitForm() {
            ...
            window.location.href = new 'ampdb-composition-search-result?' + urlParams1.toString() + '&' + urlParams2.toString() + '&' + urlParams3.toString() + '&' + urlParams4.toString() + '&' + urlParams5.toString() + '&' + urlParams6.toString() + '&' + urlParams7.toString();
        }
    </script>
    <br><br><br>
