...
<head>
    ...
    <title>AMPDB Data Stat by Activity</title>
...
<body>
    ...
    <div class="container mt-3">
        <div class="row" style="padding-left: 0rem;">
            <div class="col-sm text-start" style="font-weight: 400; font-size:xx-large">
                AMPDB Statistics: AMPDB Data Distribution by Peptide Activity
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function rescaleYAxis() {
            var newMax = Math.floor(Math.random() * 70000) + 1000;
            myChart.options.scales.y.max = newMax;
            myChart.update();
        }

        function rescaleXAxis() {
            var newMax = Math.floor(Math.random() * 93);
        ...
        myChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['Acyltransferase', 'Amphibian defense peptide', 'Anti-biofilm', 'Anti-cancer', 'Anti-candida', 'Anti-gram-negative', 'Anti-gram-positive', 'Anti-hepatities', 'Anti-HIV', 'Anti-HSV', 'Anti-inflammatory', 'Anti-listeria', 'Anti-malarial', 'Anti-mollicute', 'Anti-MRSA', 'Anti-parasititic', 'Anti-plasmodium', 'Anti-protozoal', 'Anti-tuberculosis', 'Anti-uterotonic', 'Anti-yeast', 'Antibiotic', 'Antimicrobial', 'Antinociceptive', 'Antioxidant', 'Antiviral protein', 'Aspartyl esterase', 'Autophagy', 'Bacteriocin', 'Bacteriolytic enzyme', 'Blood coagulation cascade inhibiting toxin', 'Carboxypeptidase', 'Cell membrane', 'Chemotaxis', 'Cytokine', 'Cytolysis', 'Cytolytic', 'Cytotoxin', 'Defensin', 'DNA replication inhibitor', 'DNA-directed RNA polymerase', 'Endonuclease', 'Enzyme inhibitor', 'Exonuclease', 'Fungicide', 'Glycosidase', 'Helicase', 'Hemolytic', 'Hydrolase', 'Hypotensive', 'Ichthyotoxic', 'Insecticidal', 'Isomerase', 'Lantibiotic', 'Lectin', 'Ligase', 'Lyase', 'Metalloenzyme inhibitor', 'Metalloprotease inhibitor', 'Metalloprotease', 'Methyltransferase', 'Milk protein', 'Nuclease', 'Nucleotidyltransferase', 'Oxidoreductase', 'Peroxidase', 'Plant defense', 'Platelet aggregation inhibiting toxin', 'Protease inhibitor', 'Protease', 'Protein kinase inhibitor', 'Protein synthesis inhibitor', 'Proteolytic', 'Ribosomal protein', 'RNA-directed DNA polymerase', 'Rotamase', 'Serine protease inhibitor', 'Serine protease', 'Serine threonine-protein kinase', 'Signal peptide', 'Spermicidal', 'Synergistic peptide', 'Thiol protease inhibitor', 'Thiol protease', 'Toxin', 'Transferase', 'Tumor suppressor', 'Wound healing'],
                datasets: [{
                    label: '# of Record(s)',
                    data: [1, 1187, 51, 51, 420, 5800, 2238, 2, 46, 11, 17, 31, 2, 3, 80, 100, 7, 40, 744, 1, 79, 18067, 59122, 1, 356, 33, 1, 9, 4411, 35630, 9, 1, 30, 32, 11,
                        2329, 52, 2727, 4726, 2, 3, 267, 101, 3, 4391, 20322, 2, 867, 25578, 2, 7, 62, 2, 530, 235, 2, 162, 5, 5, 5, 3, 10, 272, 5, 262, 70, 1158, 16, 100, 114, 1, 7, 13, 4, 3, 1, 91, 15, 11, 94, 17, 22, 6, 79, 465, 50, 1, 6
                    ],
