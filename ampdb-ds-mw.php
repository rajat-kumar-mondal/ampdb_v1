...
<head>
    ...
    <title>AMPDB Data Stat by Molecular Weight</title>
...
<body>
    ...
    <div class="container mt-3">
        <div class="row" style="padding-left: 0rem;">
            <div class="col-sm text-start" style="font-weight: 400; font-size:xx-large">
                AMPDB Statistics: AMPDB Data Distribution by Molecular Weight
            </div>
        </div>
    </div>
                    ...
                    <table class="table border border-2 table-striped table-hover">
                        <thead class="bg-dark text-white">
                            <tr>
                                ...
                                <th style="font-weight: 500;">Range of Molecular Weight</th>
    ...
    <script>
        ...
        function rescaleXAxis() {
            var newMax = Math.floor(Math.random() * 17);
        ...
        myChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['1-5000', '5000-10000', '10000-15000', '15000-20000', '20000-25000', '25000-30000', '30000-35000', '35000-40000', '40000-45000', '45000-50000', '50000-55000', '55000-60000', '60000-65000', '65000-70000', '70000-75000', '75000-1400000'],
                datasets: [{
                    label: '# of Record(s)',
                    data: [1422, 10609, 4863, 17853, 5809, 2659, 3041, 2338, 1815, 1564, 1808, 1096, 1097, 667, 628, 1853],
