...
<head>
    ...
    <title>AMPDB Data Stat by Instability Index</title>
...
<body>
    ...
    <div class="container mt-3">
        <div class="row" style="padding-left: 0rem;">
            <div class="col-sm text-start" style="font-weight: 400; font-size:xx-large">
                AMPDB Statistics: AMPDB Data Distribution by Instability Index
            </div>
        </div>
    </div>
                    ...
                    <table class="table border border-2 table-striped table-hover">
                        <thead class="bg-dark text-white">
                            <tr>
                                ...
                                <th style="font-weight: 500;">Range of Instability Index</th>
    ...
    <script>
        ...
        function rescaleYAxis() {
            var newMax = Math.floor(Math.random() * 35000) + 1000;
            myChart.options.scales.y.max = newMax;
            myChart.update();
        }

        function rescaleXAxis() {
            var newMax = Math.floor(Math.random() * 21);
        ...
        myChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['-40 - -30', '-29 - -20', '-19 - -10', '-9-0', '1-10', '11-20', '21-30', '31-40', '41-50', '51-60', '61-70', '71-80', '81-90', '91-100', '101-110', '111-120', '121-130', '131-140', '141-150', '151-160', '161-170'],
                datasets: [{
                    label: '# of Record(s)',
                    data: [1, 12, 57, 246, 703, 4292, 14363, 26001, 16765, 5968, 1997, 708, 239, 74, 17, 8, 5, 1, 2, 0, 2],
