...
<head>
    ...
    <title>AMPDB Specific Search Result</title>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-lg-19 bg-light rounded my-2 py-2">
                <h4 class="text-center text-success" style="font-size: 500; margin-top: 2%;"> AMPDB Specific Search Result
                </h4>
    ...
    <script>
        ...
        $.ajax({
            url: "specific-all-ids-browse-all-data.php",
            type: "POST",
            data: {
                term: term,
                ds: ds,
        ...
        $.ajax({
            url: "specific-count-browse-all-data.php",
            type: "POST",
            data: {
                term: term1,
                ds: ds1,
        ...
        $.ajax({
            url: "specific-option-browse-all-data.php",
            type: "POST",
            data: {
                term: term2,
                ds: ds2,
        ...
        function showdata() {
            isrunning = true;
            $("#loading").show();
            $.post("specific-data-browse-all-data.php", {
                term: term3,
                ds: ds3,
                page: page_no,
                activity: activity3,
        ...
        function submitForm() {
            ...
            window.location.href = new 'ampdb-specific-search-result?' + the_Ids + urlParams1.toString() + '&' + urlParams2.toString() + '&' + urlParams3.toString() + '&' + urlParams4.toString() + '&' + urlParams5.toString() + '&' + urlParams6.toString() + '&' + urlParams7.toString();
        }
    </script>
    <br><br><br>
