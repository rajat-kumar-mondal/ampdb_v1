...
<head>
    ...
    <title>AMPDB Data Stat by Hydrophobic Amino Acid Count</title>
...
<body>
    ...
    <div class="container mt-3">
        <div class="row" style="padding-left: 0rem;">
            <div class="col-sm text-start" style="font-weight: 400; font-size:xx-large">
                AMPDB Statistics: AMPDB Data Distribution by Hydrophobic Amino Acid Count
            </div>
        </div>
    </div>
                    ...
                    <table class="table border border-2 table-striped table-hover">
                        <thead class="bg-dark text-white">
                            <tr>
                                ...
                                <th style="font-weight: 500;">Range of Hydrophobic Amino Acid Count</th>
    ...
    <script>
        ...
        function rescaleXAxis() {
            var newMax = Math.floor(Math.random() * 23);
        ...
        myChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['1 >= to < 10', '10 >= to < 19', '19 >= to < 28', '28 >= to < 37', '37 >= to < 46', '46 >= to < 55', '55 >= to < 64', '64 >= to < 73', '73 >= to < 82', '82 >= to < 91', '91 >= to < 100', '100 >= to < 200', '200 >= to < 300', '300 >= to < 400', '400 >= to < 500', '500 >= to < 600', '600 >= to < 700', '700 >= to < 800', '800 >= to < 900', '900 >= to < 1000', '1000 >= to < 2000', '2000 >= to < 4000', '4000 >= to < 8000'],
                datasets: [{
                    label: '# of Record(s)',
                    data: [222, 1004, 1557, 4624, 4921, 2663, 1853, 3617, 5726, 8021, 3531, 12176, 6431, 1816, 634, 143, 55, 29, 20, 13, 59, 5, 2],
            ...
            options: {
                scales: {
                    ...
                    x: {
                        ...
                        title: {
                            display: true,
                            text: 'Hydrophobic Amino Acid Count',
                            font: {
                                size: 14
                            }
                        }
