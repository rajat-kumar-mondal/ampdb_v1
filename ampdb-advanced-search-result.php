...
<head>
    ...
    <title>AMPDB Advanced Search Result</title>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-lg-19 bg-light rounded my-2 py-2">
                <h4 class="text-center text-success" style="font-size: 500; margin-top: 2%;"> AMPDB Advanced Search Result
                </h4>
    ...
    <script>
        ...
        if (st.length == 3 || st.length == 5 || st.length == 7 || st.length == 13) {
            document.getElementById("search-term").innerHTML = "<b style='font-weight: 500'>Search Query: *</b>";
        } else {
            document.getElementById("search-term").innerHTML = "<b style='font-weight: 500'>Search Query: </b>" + st.replace(/\%/g, "").replace(/LIKE/g, "=").replace(/\= \'\' /, "").replace(/\+/g, " ").replace(/\`/g, "");
        }
        ...
        function submitForm() {
            ...
            window.location.href = new 'ampdb-advanced-search-result?' + the_Ids + urlParams1.toString() + '&' + urlParams2.toString() + '&' + urlParams3.toString() + '&' + urlParams4.toString() + '&' + urlParams5.toString() + '&' + urlParams6.toString() + '&' + urlParams7.toString();
        }
    </script>
    <br><br><br>
