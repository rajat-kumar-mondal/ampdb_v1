...
$limit = 10;
$row = ($page - 1) * $limit;
$sql = str_replace(" LIKE '%undefined%'", "", str_replace(" undefined", "", "SELECT `AMPDB_No_`, `Gene Names`, `Organism`, `Protein names`, `Length`, `peptide activity`, `target organism` FROM `master2` WHERE $advanceQuery $selDs $filterQuery $sortFilter LIMIT $row,$limit"));
