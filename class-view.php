...
<head>
    ...
    <?php echo '<title>Class: ' . $_GET['class'] . '</title>'; ?>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-lg-19 bg-light rounded my-2 py-2">
                <h4 class="text-center" style="font-size: 500; margin-top: 2%; color: #9A3863;"> <?php echo $_GET['class'] ?> <span style="color:black">Class</span>
                </h4>
                <div style="margin-left:5%; margin-right:5%;"><span id="num-rec"></span></div>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <span id="search-class"></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm">
                <form id="myForm" method="post" action="request">
                    <div style="margin-left: 5%;">
                        ...
                        <input type="text" name="file" value="<?php echo $_GET['class'] . " dataset"; ?>" style="display: none;">
    ...
    <div class="offcanvas offcanvas-start" id="demo">
        ...
        <div class="offcanvas-body">
            <form onsubmit="submitForm(); return false;">
                ...
                <input name="class" type="text" value="<?php echo $_GET['class']; ?>" style="display: none">
    ...
    <script>
        ...
        const class5 = getAllParameterValues('class');
        ...
        $.ajax({
            url: "classV-all-ids-browse-all-data.php",
            type: "POST",
            data: {
                class: class5,
                ds: ds,
        ...
        const class1 = getAllParameterValues('class');
        ...
        $.ajax({
            url: "classV-count-browse-all-data.php",
            type: "POST",
            data: {
                class: class1,
                ds: ds1,
            ...
            success: function(result) {
                if (result.length == 0) {
                    document.getElementById("num-rec").innerHTML = '<b style="font-weight: 500; color: red;">Query is not properly build. One or more condition/operator/field remain blank OR some undesired character(s) may present in the query. Unable to show result!</b>';
                } else {
                    document.getElementById("num-rec").innerHTML = '<b style="font-weight: 500;">Total Records: </b>' + result;
                    var myR = result;
        ...
        const class2 = getAllParameterValues('class');
        ...
        $.ajax({
            url: "classV-option-browse-all-data.php",
            type: "POST",
            data: {
                class: class2,
                ds: ds2,
        ...
        const class3 = getAllParameterValues('class');
        ...
        function showdata() {
            isrunning = true;
            $("#loading").show();
            $.post("classV-data-browse-all-data.php", {
                class: class3,
                ds: ds3,
                page: page_no,
                activity: activity3,
        ...
        function submitForm() {
            ...
            window.location.href = new 'class-view?' + urlParams1.toString() + '&' + urlParams2.toString() + '&' + urlParams3.toString() + '&' + urlParams4.toString() + '&' + urlParams5.toString() + '&' + urlParams6.toString() + '&' + urlParams7.toString();
        }
    </script>
    <br><br><br>
