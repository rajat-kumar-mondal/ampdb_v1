...
<head>
    ...
    <title>AMPDB Target Organism Search Result</title>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-lg-19 bg-light rounded my-2 py-2">
                <h4 class="text-center text-success" style="font-size: 500; margin-top: 2%;"> AMPDB Target Organism Search Result
                </h4>
                <div style="margin-left:5%; margin-right: 5%;"><b style="font-weight: 500;">Search Target(s): </b><?php if (strlen($_GET['term']) == 0) {
                                                                                                                        echo "*";
                                                                                                                    } else {
                                                                                                                        echo $_GET['term'];
    ...
    <script>
        ...
        $.ajax({
            url: "target-all-ids-browse-all-data.php",
            type: "POST",
            data: {
                term: term,
                ds: ds,
        ...
        $.ajax({
            url: "target-count-browse-all-data.php",
            type: "POST",
            data: {
                term: term1,
                ds: ds1,
            ...
            success: function(result) {
                if (result.length == 0) {
                    document.getElementById("num-rec").innerHTML = '<b style="font-weight: 500; color: red;">Warning: Some undesired character(s) may present in the query. Unable to show result!</b>';
                } else {
        ...
        $.ajax({
            url: "target-option-browse-all-data.php",
            type: "POST",
            data: {
                term: term2,
                ds: ds2,
        ...
        function showdata() {
            isrunning = true;
            $("#loading").show();
            $.post("target-data-browse-all-data.php", {
                term: term3,
                ds: ds3,
                page: page_no,
                activity: activity3,
        ...
        function submitForm() {
            ...
            window.location.href = new 'ampdb-target-organism-search-result?' + urlParams1.toString() + '&' + urlParams2.toString() + '&' + urlParams3.toString() + '&' + urlParams4.toString() + '&' + urlParams5.toString() + '&' + urlParams6.toString() + '&' + urlParams7.toString();
        }
    </script>
    <br><br><br>
