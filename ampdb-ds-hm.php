...
<head>
    ...
    <title>AMPDB Data Stat by Hydrophobic Moment</title>
...
<body>
    ...
    <div class="container mt-3">
        <div class="row" style="padding-left: 0rem;">
            <div class="col-sm text-start" style="font-weight: 400; font-size:xx-large">
                AMPDB Statistics: AMPDB Data Distribution by Hydrophobic Moment
            </div>
        </div>
    </div>
    ...
    <div class="container ">
        <div class="row justify-content-center border border-2">
            <div class="col-lg-19 bg-light rounded my-2 py-2">
                ...
                <?php
                require 'dbcon.php';
                $sql = "SELECT * FROM `hydro_mom_stat`";
                $res = $con->query($sql);
                ?>
                    ...
                    <table class="table border border-2 table-striped table-hover">
                        <thead class="bg-dark text-white">
                            <tr>
                                ...
                                <th style="font-weight: 500;">Range of Hydrophobic Moment</th>
    ...
    <script>
        ...
        myChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['0.0 >= to < 0.1', '0.1 >= to < 0.2', '0.2 >= to < 0.3', '0.3 >= to < 0.4', '0.4 >= to < 0.5', '0.5 >= to < 0.6', '0.6 >= to < 0.7', '0.7 >= to < 0.8', '0.8 >= to < 0.9', '0.9 >= to < 1.0', '1.0 >= to < 1.1', '1.1 >= to < 1.2'],
                datasets: [{
                    label: '# of Record(s)',
                    data: [8, 16, 79, 704, 3688, 9915, 18484, 18276, 6265, 1545, 132, 10],
